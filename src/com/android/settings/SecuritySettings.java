...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    public static class SecuritySubSettings extends SettingsPreferenceFragment
        ...
        private static final String SWITCH_PREFERENCE_KEYS[] = { KEY_LOCK_AFTER_TIMEOUT,
                ...
                KEY_POWER_INSTANTLY_LOCKS, KEY_FACE_AUTO_UNLOCK, KEY_DIRECTLY_SHOW_LOCK };
        ...
        private SwitchPreference mFaceAutoUnlock;
        ...
        public void onResume() {
            ...
            if (mFaceAutoUnlock != null) {
                mFaceAutoUnlock.setChecked(
                        NexusSettings.getBoolForCurrentUser(getContext(), NexusSettings.FACE_AUTO_UNLOCK, false));
            }
        ...
        private void createPreferenceHierarchy() {
            ...
            mFaceAutoUnlock = (SwitchPreference) findPreference(KEY_FACE_AUTO_UNLOCK);
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            } else if (KEY_FACE_AUTO_UNLOCK.equals(key)) {
                NexusSettings.putBoolForCurrentUser(getContext(), NexusSettings.FACE_AUTO_UNLOCK, (Boolean)value);
